          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-[12px] border-t border-slate-300 dark:border-slate-700 pt-3 text-slate-700 dark:text-slate-300">
            ...
            <span className="ml-auto">
              <button
                ...
                className="text-xs px-3 py-1.5 rounded-full font-semibold transition-all duration-200 hover:brightness-110 focus:outline-none bg-primary text-primary-foreground disabled:opacity-50 shadow-[0_0_20px_hsl(var(--primary)/0.5)]"
              >
