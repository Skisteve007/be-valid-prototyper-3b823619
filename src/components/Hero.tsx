    ...
    <div className="relative min-h-[85vh] bg-[#050505] text-white overflow-hidden flex flex-col items-center selection:bg-cyan-500 selection:text-black">
      ...
      <div className="flex-1 flex flex-col md:flex-row items-start justify-start w-full px-[15px] md:px-8 lg:px-12 z-10 gap-8 md:gap-12 mt-4">
        ...
        <div className="flex-1 text-left order-2 md:order-1 md:pl-0 lg:pl-4">
          ...
          <p className="text-base text-gray-200 mb-6 font-light max-w-md leading-relaxed">
          ...
          <div className="mt-8">
            ...
            {/* Dynamic Description */}
            <p className="text-sm text-gray-200 mt-3 text-left max-w-md transition-all duration-300">
              {signalModes[activeSignal].description}
            </p>
            {/* Static profiles paragraph - UNDER the dropdown */}
            <p className="text-sm text-gray-200 mt-4 text-left max-w-lg leading-relaxed">
      ...
      <div className="w-full max-w-7xl px-[15px] md:px-6 z-10 mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="p-5 rounded-xl border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-sm hover:border-cyan-400/50 transition-all">
            ...
            <p className="text-sm text-gray-200 leading-relaxed">{t('hero.instantEntryDesc')}</p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-green-500/30 bg-green-500/5 backdrop-blur-sm hover:border-green-400/50 transition-all">
            ...
            <p className="text-sm text-gray-200 leading-relaxed">{t('hero.secureFundsDesc')}</p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-purple-500/30 bg-purple-500/5 backdrop-blur-sm hover:border-purple-400/50 transition-all">
            ...
            <p className="text-sm text-gray-200 leading-relaxed">{t('hero.dataLockDesc')}</p>
          </div>
        </div>
      </div>
