  ...
  return (
    <nav className="border-b border-border bg-background sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-5 flex items-center justify-between relative">
        {/* Logo + Beta Pill */}
        <div className="flex items-center gap-2 md:gap-3 md:relative absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto">
          <Link 
            to="/" 
          ...
          <span className="px-2 md:px-3 py-0.5 md:py-1 text-[8px] md:text-[10px] font-bold tracking-wider uppercase rounded-full border border-cyan-400/60 bg-cyan-500/10 text-cyan-400 shadow-[0_0_15px_rgba(0,255,255,0.4)] animate-pulse">
            Beta
          </span>
        </div>
