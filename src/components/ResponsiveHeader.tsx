...
const ResponsiveHeader = () => {
  ...
  return (
    <>
      {!hideHeader && (
        <header className="w-full px-2 sm:px-8 md:px-16 lg:px-24 py-4 sm:py-6 flex items-center justify-between gap-3 bg-transparent absolute top-0 left-0 right-0 z-50">
          {/* Logo - Text Only */}
