          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
              ...
              <Link
                ...
                className="px-1.5 sm:px-4 py-1 sm:py-2 text-[0.45rem] sm:text-xs font-bold tracking-wide sm:tracking-wider uppercase rounded-full border border-purple-400/60 bg-purple-500/10 text-purple-400 hover:bg-purple-500/15 hover:shadow-[0_0_16px_rgba(168,85,247,0.35)] transition-all whitespace-nowrap"
              >
                Labs
              </Link>
              ...
              <Link
                to="/demos"
                className="px-1.5 sm:px-4 py-1 sm:py-2 text-[0.45rem] sm:text-xs font-bold tracking-wide sm:tracking-wider uppercase rounded-full border border-emerald-400/60 bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/15 hover:shadow-[0_0_16px_rgba(52,211,153,0.35)] transition-all whitespace-nowrap"
              >
                Demos
              </Link>
              ...
              <Link
                to="/partners"
                className="px-1.5 sm:px-4 py-1 sm:py-2 text-[0.45rem] sm:text-xs font-bold tracking-wide sm:tracking-wider uppercase rounded-full border border-amber-400/60 bg-amber-500/10 text-amber-400 hover:bg-amber-500/15 hover:shadow-[0_0_16px_rgba(251,191,36,0.35)] transition-all whitespace-nowrap"
              >
                Partners
              </Link>
              ...
              <Link
                to="/auth?mode=login"
                className="px-1.5 sm:px-4 py-1 sm:py-2 text-[0.45rem] sm:text-xs font-bold tracking-wide sm:tracking-wider uppercase rounded-full border border-cyan-400/60 bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/15 hover:shadow-[0_0_16px_rgba(0,240,255,0.35)] transition-all whitespace-nowrap"
              >
                Login
              </Link>
