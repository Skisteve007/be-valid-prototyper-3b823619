...
import { submitEventIntake } from '@/hooks/useEventIntakeSubmit';
import {
  Ghost,
  Calendar,
  MapPin,
...
export const GhostPassEventIntakeForm = ({ isOpen, onClose }: GhostPassEventIntakeFormProps) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      // Use the new multi-table submission that writes to events, event_configuration, access_points, and ghost_pass_event_intakes
      const result = await submitEventIntake({
        ...
        numExteriorGaPoints: data.numExteriorGaPoints,
        numExteriorVipPoints: data.numExteriorVipPoints,
        numInteriorReentryPoints: data.numInteriorReentryPoints,
        reentryAllowed: data.reentryAllowed,
        interiorLocations: data.interiorLocations,
        numBarLocations: data.numBarLocations,
        numServerStations: data.numServerStations,
        numTableServiceAreas: data.numTableServiceAreas,
        numFoodConcessions: data.numFoodConcessions,
        numMerchLocations: data.numMerchLocations,
        numVipLounges: data.numVipLounges,
        numCountertopUnits: data.numCountertopUnits,
        countertopLocations: data.countertopLocations,
        numHandheldUnits: data.numHandheldUnits,
        handheldLocations: data.handheldLocations,
        passTypes: data.passTypes as any,
        acceptedWalletMethods: data.acceptedWalletMethods,
        platformFeeEnabled: data.platformFeeEnabled,
        platformFeeAmount: data.platformFeeAmount,
        settlementCurrency: data.settlementCurrency,
        idRequiredFor: data.idRequiredFor,
        idMandatoryAtEntry: data.idMandatoryAtEntry,
        additionalAttributes: data.additionalAttributes,
        idVerificationTier: data.idVerificationTier,
        interactionMethod: data.interactionMethod,
        wearableIntegrationRequired: data.wearableIntegrationRequired,
        wearableUseGhostPass: data.wearableUseGhostPass,
        wearableTypes: data.wearableTypes,
        wearableVendorContactName: data.wearableVendorContactName,
        wearableVendorContactEmail: data.wearableVendorContactEmail,
        wearableVendorCompany: data.wearableVendorCompany,
        wearableApiEndpoint: data.wearableApiEndpoint,
        wearableApiNotes: data.wearableApiNotes,
        hasOutsideVendors: data.hasOutsideVendors,
        outsideVendorCount: data.outsideVendorCount,
        outsideVendorTypes: data.outsideVendorTypes,
        legalBusinessName: data.legalBusinessName,
        entityType: data.entityType,
        bankAccountCountry: data.bankAccountCountry,
        stripeConnectExists: data.stripeConnectExists,
        payoutTiming: data.payoutTiming,
        payoutDestination: data.payoutDestination as any,
        hasPromoter: data.hasPromoter,
        promoterSplits: data.promoterSplits,
        vendors: data.vendors,
        enableRealtimeDashboard: data.enableRealtimeDashboard,
        estimatedStaffAtPeak: data.estimatedStaffAtPeak,
        numManagementAccessCodes: data.numManagementAccessCodes,
        numOwnershipGatewayCodes: data.numOwnershipGatewayCodes,
        sensoryCargosEnabled: data.sensoryCargosEnabled,
        sensoryAudiology: data.sensoryAudiology,
        sensoryVisual: data.sensoryVisual,
        sensoryTaste: data.sensoryTaste,
        sensoryTouch: data.sensoryTouch,
        sensoryOlfactory: data.sensoryOlfactory,
        sensoryAtmospheric: data.sensoryAtmospheric,
        sensoryNotes: data.sensoryNotes,
        jurisdictionNotes: data.jurisdictionNotes,
      ...
      toast({
        ...
        description: `Your Ghost Pass event configuration has been created (Event ID: ${result.eventId?.slice(0, 8)}...).`,
      });
    } catch (error: any) {
