...
export const AGREEMENT_TIERS: TierConfig[] = [
  {
    ...
    price: "$1,000,000–$5,000,000 upfront (3-year exclusive) + 10% Onboarding & Systems Integration Fee (due at signing; also due at each annual renewal)",
    priceValue: 1000000,
  ...
  },
  {
    ...
    price: "$250,000/year (paid upfront) + 10% Onboarding & Systems Integration Fee (due at signing; also due at each annual renewal)",
    priceValue: 250000,
  ...
  },
  {
    ...
    price: "$75,000 paid pilot → $300,000/year + 10% Onboarding & Systems Integration Fee (due at signing; also due at each annual renewal)",
    priceValue: 75000,
  ...
  },
  {
    ...
    price: "$5,000 setup + $499/month + 10% Onboarding & Systems Integration Fee (due at signing; also due at each annual renewal)",
    priceValue: 5000,
