        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex flex-1 justify-center px-8">
              <p className="text-base font-semibold text-center whitespace-nowrap bg-gradient-to-r from-blue-600 via-pink-600 to-blue-700 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]">
      ...
      <main>
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold inline-block px-8 py-3 bg-gradient-to-r from-blue-600/20 via-pink-600/20 to-blue-600/20 rounded-full border border-primary/30">
