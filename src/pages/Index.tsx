        ...
        <div className="container mx-auto px-4 py-4 md:py-6 relative">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="hidden lg:flex flex-1 flex-col justify-center items-center px-8">
              <div className="relative px-20 py-2 rounded-full bg-gradient-to-r from-blue-400/30 via-pink-400/25 to-blue-400/30 border border-blue-300/50">
                ...
                <p className="relative text-lg xl:text-xl font-black text-center italic tracking-[0.25em] whitespace-nowrap bg-gradient-to-r from-gray-400 via-gray-600 to-gray-400 bg-clip-text text-transparent" style={{ textShadow: '1px 0 0 rgba(120,120,120,0.3), -1px 0 0 rgba(120,120,120,0.3)' }}>
          ...
          <div className="lg:hidden text-center mt-2">
            <div className="relative inline-block px-12 py-1.5 rounded-full bg-gradient-to-r from-blue-400/30 via-pink-400/25 to-blue-400/30 border border-blue-300/50">
              ...
              <p className="relative text-sm font-black italic tracking-[0.2em] whitespace-nowrap bg-gradient-to-r from-gray-400 via-gray-600 to-gray-400 bg-clip-text text-transparent" style={{ textShadow: '1px 0 0 rgba(120,120,120,0.3), -1px 0 0 rgba(120,120,120,0.3)' }}>
                Instant Proof Health Status
              </p>
            </div>
