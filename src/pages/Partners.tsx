      ...
      <nav className="border-b border-white/10 bg-black/90 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-5 sm:py-6 flex justify-between items-center">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <Link 
              to="/pitch-deck" 
              className="flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs sm:text-sm font-bold rounded-full transition-all uppercase tracking-wider shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_30px_rgba(6,182,212,0.6)]"
            >
              <Eye className="h-4 w-4 sm:h-4.5 sm:w-4.5 animate-pulse drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
              Investors
            </Link>
          </div>
          ...
          <div className="hidden xl:flex items-center gap-4 text-sm font-mono tracking-wider absolute left-1/2 -translate-x-1/2">
            ...
            <div className="flex flex-col items-center gap-1.5">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-cyan-400 font-bold tracking-[0.18em] text-base">IDENTITY • ACCESS</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-400 font-bold tracking-[0.18em] text-base">PAYMENTS • TRUST</span>
            </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link 
              to="/vendor-pricing" 
              className="group flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-purple-600/80 to-cyan-600/80 border border-purple-500/40 hover:border-cyan-400/60 rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)]"
            >
              <span className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider">Pricing</span>
            </Link>
            <Link 
              to="/" 
              className="group flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-2.5 bg-black/60 border border-white/20 hover:border-cyan-400/60 rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,240,255,0.3)]"
            >
              <div className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-green-400 shadow-[0_0_8px_rgba(74,222,128,0.8)] animate-pulse"></div>
              <span className="text-xs sm:text-sm font-bold text-white/80 group-hover:text-white uppercase tracking-wider">App</span>
              <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-cyan-400 group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </div>
        </div>
      </nav>
