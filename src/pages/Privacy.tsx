        ...
        <div className="max-w-4xl mx-auto prose prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4 text-muted-foreground">
              <li><strong className="text-foreground">Account Information:</strong> Name, email address, payment information</li>
              <li><strong className="text-foreground">Health Information:</strong> Voluntarily uploaded health status documents and certifications</li>
              <li><strong className="text-foreground">Usage Data:</strong> How you interact with our platform, QR code views, login timestamps</li>
              <li><strong className="text-foreground">Device Information:</strong> IP address, browser type, device identifiers</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4 text-muted-foreground">
              <li><strong className="text-foreground">Other Users:</strong> When you choose to share your QR code, recipients can view your verified health status</li>
              <li><strong className="text-foreground">Service Providers:</strong> Payment processors, hosting services, email providers</li>
