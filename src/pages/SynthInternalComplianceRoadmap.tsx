...
const SynthInternalComplianceRoadmap: React.FC = () => {
  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        const response = await fetch('/COMPLIANCE_ROADMAP_INTERNAL.md');
        if (response.ok) {
  ...
  return (
    <SynthAdminGate pageTitle="Compliance Roadmap">
      <Helmet>
...
export default SynthInternalComplianceRoadmap;
