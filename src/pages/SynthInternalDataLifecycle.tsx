...
const SynthInternalDataLifecycle: React.FC = () => {
  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        const response = await fetch('/DATA_LIFECYCLE_POLICY_INTERNAL.md');
        if (response.ok) {
  ...
  return (
    <SynthAdminGate pageTitle="Data Lifecycle Policy">
      <Helmet>
...
export default SynthInternalDataLifecycle;
