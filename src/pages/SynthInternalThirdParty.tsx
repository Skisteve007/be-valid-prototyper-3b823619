...
const SynthInternalThirdParty: React.FC = () => {
  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        const response = await fetch('/THIRD_PARTY_DEPENDENCY_PLAN_INTERNAL.md');
        if (response.ok) {
  ...
  return (
    <SynthAdminGate pageTitle="Third-Party Dependency Plan">
      <Helmet>
...
export default SynthInternalThirdParty;
