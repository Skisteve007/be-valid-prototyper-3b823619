      ...
      <div className="max-w-4xl mx-auto px-5 pb-20">
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 border border-emerald-500/30 rounded-2xl p-8 shadow-[0_0_30px_rgba(16,185,129,0.15)]">
          ...
          <p className="text-slate-300 mb-6 text-base md:text-lg">
            Connect venues, refer members, and transform your influence into income. We offer a <strong className="text-white">dual revenue model</strong>—earning instant commission from every Incognito scan <em>plus</em> a structured commission on the <strong className="text-white">Venue&apos;s Gross Revenue</strong> (Door and Bar Sales) generated by your patrons.
          </p>
          ...
          <div className="p-5 bg-slate-800/70 rounded-lg border border-emerald-500/30 mb-6">
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-3 ml-4 text-sm md:text-base">
              <li>
                <strong className="text-white">INSTANT ACCESS COMMISSION:</strong> Earn a highly competitive commission from every $5.00 Incognito QR scan sold via your referrals. This payout is credited to your Affiliate Fund <strong className="text-white">near-immediately</strong>, mirroring the venue&apos;s instant payment.
              </li>
              <li>
                <strong className="text-white">GROSS REVENUE SHARE (The Big Picture):</strong> Earn a structured commission based on the <strong className="text-white">total venue revenue</strong> (door cover, bar tabs, bottle service) generated by every patron who scanned your QR code. <strong className="text-white">This is our most valuable earning tier.</strong> <em className="text-slate-400">Specific revenue details are confidential and provided upon contract review.</em>
              </li>
            </ul>
