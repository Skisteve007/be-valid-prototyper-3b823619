        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 border border-emerald-500/30 rounded-2xl p-8 shadow-[0_0_30px_rgba(16,185,129,0.15)]">
          ...
          <div className="p-5 bg-slate-800/70 rounded-lg border border-emerald-500/30 mb-6">
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-3 ml-4 text-sm md:text-base">
              <li>
                <strong className="text-white">INSTANT ACCESS COMMISSION:</strong> Earn <strong className="text-emerald-400">$1.00</strong> from every $5.00 Incognito QR scan sold via your referrals. This payout is credited to your Affiliate Fund <strong className="text-white">near-immediately</strong>, mirroring the venue&apos;s instant payment.
              </li>
              <li>
                <strong className="text-white">GROSS REVENUE SHARE (The Big Picture):</strong> Earn a structured commission based on the <strong className="text-white">total venue revenue</strong> (door cover, bar tabs, bottle service) generated by every patron who scanned your QR code. <em className="text-slate-400">Details of the tiered revenue split are provided upon application review.</em>
              </li>
            </ul>
