-- Update the profile restoration function with complete and corrected profile data
...
BEGIN
  ...
  IF v_user_id IS NOT NULL THEN
    ...
    INSERT INTO public.profiles (
      ...
      '["Men", "Women", "Couples", "Groups"]'::jsonb,
      false, -- COVID Vaccinated not checked
      false, -- Circumcised not checked
      false, -- Smoker not checked
      'green', -- Default Clean status
